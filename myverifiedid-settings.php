...
function MyVerifiedID_Options_Page() {
  ...
  <li><br></li>
	...
	<table class="form-table">
		...
		<td>
      <?php if(!isset($myverifiedid_connect['mvi_load_style'])) $myverifiedid_connect['mvi_load_style'] = 1; ?>
    ...
    <input name="mvi_load_style" id="mvi_load_style_no" value="b" type="radio" <?php if(isset($myverifiedid_connect['mvi_load_style']) && $myverifiedid_connect['mvi_load_style'] == 0){?> checked <?php } ?>> <img src="<?php echo WP_PLUGIN_URL?>/wp-myverifiedid-connect/images/signIn-style-b.jpg"/>		
		</td>
		</tr>
